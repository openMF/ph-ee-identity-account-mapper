...
public interface AddPaymentModalityApi {
    ...
    ResponseEntity<ResponseDTO> addPaymentModality(@RequestHeader(value="X-CallbackURL") String callbackURL, @RequestHeader(value = "registeringInstitutionId") String registeringInstitutionId,
