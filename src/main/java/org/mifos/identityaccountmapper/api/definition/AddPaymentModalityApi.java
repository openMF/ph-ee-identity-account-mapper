...
public interface AddPaymentModalityApi {
    ...
    ResponseEntity<ResponseDTO> addPaymentModality(@RequestHeader(value="X-CallbackURL") String callbackURL, @RequestHeader(value = "X-Registering-Institution-ID") String registeringInstitutionId,
